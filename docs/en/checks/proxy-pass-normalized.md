---
title: "proxy_pass Path Normalization Issues"
description: "Guard against proxy_pass normalization and double-encoding surprises so upstream paths stay predictable and safe."
---

# proxy_pass Path Normalization Issues
