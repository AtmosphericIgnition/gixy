---
title: "worker_rlimit_nofile vs worker_connections"
description: "Raise worker_rlimit_nofile to at least 2× worker_connections so NGINX doesn't exhaust file descriptors under load."
---
