...
description: "Uncover SSRF risks in NGINX. Lock down internal redirects and variable-driven proxy_pass targets so internal networks stay unreachable."
---

# Server Side Request Forgery

_Gixy Check ID: `ssrf`_
