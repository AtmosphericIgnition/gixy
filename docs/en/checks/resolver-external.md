---
title: "External DNS Resolver Security"
description: "Avoid pointing resolver at public DNS in NGINX. Use trusted local resolvers to dodge cache poisoning and spoofed replies."
---

# Using External DNS Nameservers

_Gixy Check ID: `resolver_external`_
