---
title: "Invalid Regex Capture Groups"
description: "Fix references to missing capture groups in rewrite/if expressions—empty matches can break logic."
---

# Using a Nonexistent Regex Capture Group

_Gixy Check ID: `invalid_regex`_
