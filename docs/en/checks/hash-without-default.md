---
title: "Missing Default in Hash Blocks"
description: "Map and geo blocks need explicit defaults—without them, unexpected keys can slip through."
---

# Missing Default in Hash Blocks (map, geo)
