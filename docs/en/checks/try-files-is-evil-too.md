---
title: "try_files Without open_file_cache"
description: "Enable open_file_cache when using try_files to slash stat() overhead and keep throughput high."
---

# try_files Without open_file_cache

_Gixy Check ID: `try_files_is_evil_too`_
