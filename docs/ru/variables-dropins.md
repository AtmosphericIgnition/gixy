---
title: "Пользовательские переменные и drop-ins"
description: "Учите Gixy сторонним переменным NGINX через drop-ins, чтобы убрать лишние предупреждения и повысить точность."
---
