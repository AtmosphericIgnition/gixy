---
title: "Отсутствует default_server"
description: "Отметьте один сервер как default_server на общем порту, чтобы исключить двусмысленную маршрутизацию."
---

# Отсутствует default_server при общем сокете listen
