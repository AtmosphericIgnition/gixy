---
title: "proxy_pass и нормализация пути"
description: "Неожиданное декодирование/нормализация пути в proxy_pass: держите пути предсказуемыми и без двойного кодирования."
---
