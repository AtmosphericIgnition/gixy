---
title: "Content-Type через add_header"
description: "Не плодите дубли Content-Type: используйте default_type и добавляйте заголовок только когда скрываете бэкендовый Content-Type."
---
