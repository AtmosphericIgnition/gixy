---
title: "HTTP 拆分"
description: "检测可注入 CRLF 的变量或参数，避免形成额外响应头或拆分请求，降低 HTTP Splitting 引发的缓存投毒、会话劫持等风险。文章给出修复建议与安全替代写法。适用于安全审计与上线前自检，帮助团队统一配置规范、减少误配并降低风险。"
---

# HTTP 拆分

_Gixy Check ID: `http_splitting`_
