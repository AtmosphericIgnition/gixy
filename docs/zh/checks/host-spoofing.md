---
title: "Host 头伪造"
description: "建议使用 $host 而非 $http_host，避免 Host 头伪造影响重定向、生成链接或上游路由，从而减少钓鱼与 SSRF 风险。文章说明差异与推荐的校验方式，便于落地。适用于安全审计与上线前自检，帮助团队统一配置规范、减少误配并降低风险。"
---

# 伪造请求的 Host 头

_Gixy Check ID: `host_spoofing`_
