---
title: "Origin/Referer 校验问题"
description: "提醒用正则校验 Origin/Referer 容易误放行，可能被构造绕过从而影响 CORS 或点击劫持防护。文章建议使用明确白名单与严格匹配策略，降低误判风险。适用于安全审计与上线前自检，帮助团队统一配置规范、减少误配并降低风险。"
---

# 引用来源（Referer/Origin）校验问题

_Gixy Check ID: `origins`_
